 ...
 */
metadata {
	definition (name: "FA Simulated Minimote", namespace: "smartthings/testing", author: "FA MODIFIED SmartThings") {
		capability "Actuator"
		capability "Button"
	...
	tiles {
		standardTile("button", "device.button") {
 		...
 		standardTile("push1", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Call Firas", backgroundColor: "#ffffff", action: "push1"
		}
 		standardTile("push2", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Parking", backgroundColor: "#ffffff", action: "push2"
		}
 		standardTile("push3", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "luv u Iman", backgroundColor: "#ffffff", action: "push3"
		}
 		standardTile("push4", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Luv u Nour", backgroundColor: "#ffffff", action: "push4"
		}
 		...
 		standardTile("hold1", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Pickup Phone", backgroundColor: "#ffffff", action: "hold1"
		}
 		standardTile("hold2", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "Nour Bed", backgroundColor: "#ffffff", action: "hold2"
		}
 		...
 		standardTile("hold3", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "noise", backgroundColor: "#ffffff", action: "hold3"
		}
 		standardTile("hold4", "device.button", width: 1, height: 1, decoration: "flat") {
			state "default", label: "sleep", backgroundColor: "#ffffff", action: "hold4"
		}
